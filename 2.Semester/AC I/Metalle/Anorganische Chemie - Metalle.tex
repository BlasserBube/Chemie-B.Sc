...
\begin{itemize}
    ...
    \item[2.] Amalgame mit Phasenbreiten (intermet. Verbindung)\\\ce{HgIn_{1 +- x}; Hg_{2 +- x}Tl}
    \item[3.] Amalgame mit Löckenlose Mischbarkeit (farbe Lösung)\\\ce{Hg_xAu_{1-x}}
\end{itemize}
...
\begin{itemize}
    ...
    \item \ce{In,Tl} Begleiter von \ce{Sn,Pb}
\end{itemize}

\subsubsection{Zinn,Blei,Actino-,Bismut}
\ce{Sn,Pb}: oxidisch (\ce{Sn}) und sulfidisch (\ce{Pb})\\
