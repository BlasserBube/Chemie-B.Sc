...
a)\begin{eqnarray*}
    C_p = C_V+R_S,\,R_S = \frac{R}{M} = \frac{8.3145}{8} = 1.03925\cdot\,\mathrm{\frac{J}{K\cdot mol}}\\
    C_V = C_p - R_S = 19.75075\,\mathrm{\frac{J}{mol\cdot K}}
    \delta q = C_V\,dT\\
    \delta q = 19.75075\cdot 10 \,\mathrm{J}\\
    \delta q = 197.5075\,\mathrm{J}\\
    w = -p\Delta V = 0\\
\end{eqnarray*}
Es wird keine Arbeit verrichtet
b)\begin{eqnarray*}
    p_{ex} = 0,\,w=-\int_{V_A}^{V_E}p_{ex}\,dV=0\\
\end{eqnarray*}
Es wird keine Arbeit geleistet\\
Bei konstantem Druck:
\begin{eqnarray*}
    \delta q_p = C_p\,dT = 207.9\,\mathrm{J}\\
\end{eqnarray*}

\subsection*{Aufgabe 3.2}
\begin{eqnarray*}
    (C+c_v)\Delta T = m\cdot q\\
    \frac{(C+c_v)\Delta T}{m} = q\\
    \frac{(5100+0.24025352)\cdot 1.64}{0.2}\,\mathrm{\frac{J}{g}}=q\\
    41821.97\,\mathrm{\frac{J}{g}}=41.8220\,\mathrm{\frac{kJ}{g}}=q
\end{eqnarray*}
Standardverbrennungsenthalpie = $-3228\,\mathrm{\frac{kJ}{mol}}$
