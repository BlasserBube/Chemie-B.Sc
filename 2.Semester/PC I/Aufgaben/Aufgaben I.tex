...
\begin{equation*}
    E_{pot} = 4\epsilon\left(\left(\frac{r_0}{r}\right)^{12} - \left(\frac{r_0}{r}\right)^6\right)
\end{equation*}
\begin{equation*}
    F = \frac{dE_{pot}}{dr}=\left(\left(-12\cdot 4\epsilon r_0^{12} \cdot r^{-13}\right)-\left(-6\cdot 4\epsilon r_0^6r^{-7}\right)\right)
\end{equation*}
\begin{equation*}
    \frac{48\epsilon r_0^{12}}{r^13} - \frac{24\epsilon r_0^6}{r^7} = 0
\end{equation*}
damit:
\begin{equation*}
