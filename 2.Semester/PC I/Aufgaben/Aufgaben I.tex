...
\end{center}
b)\begin{eqnarray*}
    n=\frac{pV}{RT} \approx 0.0198\,\mathrm{mol}\\
    (B) V_B = 2V_A = 49\,\mathrm{l}\\
    p = \frac{nRT}{V} \approx 0.9698\,\mathrm{bar}\\
    T_B = T_A = 289\,\mathrm{K}\\\\
    (C) V_C = V_A = 24.5\,\mathrm{l}\\
    p_C = p_B = 0.9698\,\mathrm{bar}\\
    T = \frac{pV}{nR} \approx 144.3267
\end{eqnarray*}
c)\begin{eqnarray*}
    (A\rightarrow B) w = -nRT\ln\left(\frac{V_E}{V_A}\right) = -34.0050\,\mathrm{J}\\
    q_w = nRT\ln\frac{V_B}{V_A} = 34.0050\,\mathrm{J}\\
    (B\rightarrow C) w = -p_ex\Delta V = -23.7601\,\mathrm{J}\\
    q = \Delta U - w = 
    (C\rightarrow A) w = 0, q = 0
\end{eqnarray*}
d)\begin{eqnarray*}
    \eta = \frac{-w}{q} = 1.6987
\end{eqnarray*}
...
\begin{eqnarray*}
    \Delta S_{Ges} = \Delta S_W -\Delta S_K = \frac{q_K}{T_K}-\frac{q_W}{T_W} = n_1R\ln\frac{V_B}{V_A} - n_2R\ln\frac{V_D}{V_C}
\end{eqnarray*}

\subsection*{Aufgabe 4.3}
\begin{eqnarray*}
    \Delta S_{Ges} = \Delta S_2 -\Delta S_1 = q(\frac{1}{T_1}-\frac{1}{T_2})\\
    \Delta S = \int_{T_1}^{T_2} C_p \frac{1}{T}\,dT
\end{eqnarray*}

\subsubsection*{Aufgabe 4.4}
a)\begin{eqnarray*}
    q_p = q_{rev} = \Delta H = 6000\,\mathrm{J}\\
    \Delta S_{Sys} = \frac{q_{rev}}{T} = \frac{6000\,\mathrm{J}}{273\,\mathrm{K}} = 21.9780\,\mathrm{\frac{J}{K}}\\
    \Delta S_{Umg} = \frac{-q}{T} = \frac{-6000}{273} = -21.9780\,\mathrm{\frac{J}{K}}\\
    \Delta S_{Ges} = \Delta S_{Umg} + \Delta S_{Sys} = 0
\end{eqnarray*}
b) nicht ganz verstanden wie Vorzugehen ist.
\end{document}