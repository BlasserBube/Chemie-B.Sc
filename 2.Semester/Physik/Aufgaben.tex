...
\subsection*{Aufgabe 2}
a)\begin{eqnarray*}
    C=\frac{Q}{U},\, Q = \frac{\sigma}{\varepsilon^2A},\,U=dE\\
    C=\frac{\frac{\sigma}{\varepsilon^2A}}{dE}\\
    d=\frac{\sigma}{\varepsilon^2ACE}\\
    \sigma = \frac{\varepsilon^2ACE}{d}\\
    \sigma = \frac{\varepsilon^2ACE}{\frac{1}{10}d} = \frac{10 \varepsilon^2ACE}{d}
\end{eqnarray*}
Verzehnfacht sich\\
b)\begin{eqnarray*}
    D=\frac{Q}{A},\,A = \frac{dC}{\varepsilon_0}\\
    D=\frac{Q\varepsilon_0}{dC}\\
    D=\frac{Q\varepsilon_0}{\frac{1}{10}dC}\\
    D=\frac{10Q\varepsilon_0}{dC}
\end{eqnarray*}
Verzehnfacht sich\\
c)\begin{eqnarray*}
    E=\frac{U}{d}\\
    E=\frac{U}{\frac{1}{10}d}\\
    E=\frac{10U}{d}
\end{eqnarray*}
Verzehnfacht sich\\
d)\begin{eqnarray*}
...
e)\begin{eqnarray*}
    w_{el}=\frac{W}{V}=\frac{1}{2}\varepsilon_0\varepsilon_rE^2\\
    w_{el}=\frac{W}{V}=\frac{1}{2}\varepsilon_0\varepsilon_r\left(\frac{U}{d}\right)^2\\
    w_{el}=\frac{W}{V}=\frac{1}{2}\varepsilon_0\varepsilon_r\left(\frac{U}{\frac{1}{10}d}\right)^2\\
    w_{el}=\frac{W}{V}=\frac{1}{2}\varepsilon_0\varepsilon_r\left(\frac{10U}{d}\right)^2\\
    w_{el}=\frac{W}{V}=\frac{1}{2}\varepsilon_0\varepsilon_r\frac{100U^2}{d^2}\\
\end{eqnarray*}
Verhundertfacht sich\\
f)\begin{eqnarray*}
    W=\frac{1}{2}CU^2\\
    W=\frac{1}{2}C\left(dE\right)^2\\
    W=\frac{1}{2}C\left(\frac{1}{10}dE\right)^2\\
    W=\frac{1}{2}C\frac{1}{100}d^2E^2\\
\end{eqnarray*}
Verringert sich um den Faktor 0.01\\
g)\begin{eqnarray*}
    2F=qE\\
    F=\frac{qU}{d}\\
    F=\frac{qU}{\frac{1}{10}d}\\
    F=\frac{10qU}{d}
\end{eqnarray*}
Verzehnfacht sich\\
e)\begin{eqnarray*}
